...
class VFLServerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_client_selected_lsh_index = channel.unary_unary(
                '/VFLServerService/get_client_selected_lsh_index',
                request_serializer=vfl__server__service__pb2.client_hash_info_request.SerializeToString,
                response_deserializer=vfl__server__service__pb2.vfl_server_selected_lsh_index_response.FromString,
                )
        ...
        self.get_client_weight_allocation = channel.unary_unary(
                '/VFLServerService/get_client_weight_allocation',
                request_serializer=vfl__server__service__pb2.client_weight_request.SerializeToString,
                response_deserializer=vfl__server__service__pb2.client_weight_allocation_response.FromString,
                )
...
def add_VFLServerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'get_client_selected_lsh_index': grpc.unary_unary_rpc_method_handler(
                    servicer.get_client_selected_lsh_index,
                    request_deserializer=vfl__server__service__pb2.client_hash_info_request.FromString,
                    response_serializer=vfl__server__service__pb2.vfl_server_selected_lsh_index_response.SerializeToString,
            ),
            ...
            'get_client_weight_allocation': grpc.unary_unary_rpc_method_handler(
                    servicer.get_client_weight_allocation,
                    request_deserializer=vfl__server__service__pb2.client_weight_request.FromString,
                    response_serializer=vfl__server__service__pb2.client_weight_allocation_response.SerializeToString,
            ),
    }
...
class VFLServerService(object):
    ...
    @staticmethod
    def get_client_selected_lsh_index(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/VFLServerService/get_client_selected_lsh_index',
            vfl__server__service__pb2.client_hash_info_request.SerializeToString,
            vfl__server__service__pb2.vfl_server_selected_lsh_index_response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def get_client_weight_allocation(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/VFLServerService/get_client_weight_allocation',
            vfl__server__service__pb2.client_weight_request.SerializeToString,
            vfl__server__service__pb2.client_weight_allocation_response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
